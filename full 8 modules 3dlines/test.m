...
cameraInfo3.attitude = [15;0;-45]; % deg
cameraInfo3.X = -50;
cameraInfo3.Y = 15;
cameraInfo3.Z = 0; % meters

%camera 4
cameraInfo4.resolution = [7680;4320];
cameraInfo4.FOV_w = 157;
cameraInfo4.FOV_l = 80;
cameraInfo4.attitude = [15;0;45];
cameraInfo4.X = 50;
cameraInfo4.Y = 15;
cameraInfo4.Z = 0;
...
cameraInfo5.attitude = [15;0;-45]; % deg
cameraInfo5.X = -50;
cameraInfo5.Y = 25;
cameraInfo5.Z = 0; % meters

%camera 6
cameraInfo6.resolution = [7680;4320];
cameraInfo6.FOV_w = 157;
cameraInfo6.FOV_l = 80;
cameraInfo6.attitude = [15;0;45];
cameraInfo6.X = 50;
cameraInfo6.Y = 25;
cameraInfo6.Z = 0;
...
cameraInfo7.attitude = [15;0;-45]; % deg
cameraInfo7.X = -50;
cameraInfo7.Y = 35;
cameraInfo7.Z = 0; % meters

%camera 8
cameraInfo8.resolution = [7680;4320];
cameraInfo8.FOV_w = 157;
cameraInfo8.FOV_l = 80;
cameraInfo8.attitude = [15;0;45];
cameraInfo8.X = 50;
cameraInfo8.Y = 35;
cameraInfo8.Z = 0;
